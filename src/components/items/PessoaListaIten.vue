<template >
  ...
  <li class="card d-flex  col-sm-12 w-auto pr-8 bg-transparent">
    <div class="card border border-light rounded w-auto h-auto p-3 mr-2" >
      ...
      <h4 class="card-text font-weight-light">Nascimento:{{ pessoa.dataNascimento }}</h4>
       
     
     
      <div class="card-text">
      <div class="card-link d-flex justify-content-end">
        <router-link :to="`/usuario/${pessoa.id}` " class="btn btn-info btn-sm  ">Produtos deste cliente</router-link>   
        <button
